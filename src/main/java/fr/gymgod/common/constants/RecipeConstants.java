...
public final class RecipeConstants {
    ...
    public static final String MAX_POTASSIUM_MG_PER_100G           = "5000.0";
    public static final String MAX_CALCIUM_MG_PER_100G             = "3000.0";
    public static final String MAX_IRON_MG_PER_100G                = "100.0";
    public static final String MAX_CHOLESTEROL_MG_PER_100G         = "3000.0";
    ...
    public static final String MAX_PREPARED_RATIO                  = "20.0";
