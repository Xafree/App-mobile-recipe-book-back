package fr.gymgod.etl.domain.service;

import java.util.ArrayList;
import java.util.List;

/**
 * Pure domain utility for parsing ETL data lines and extracting text values.
 */
public class EtlDataParser {

    private EtlDataParser() {
        // Utility class
    }

    public static String getValue(String[] columns, int index) {
    ...
    public static int getValueInt(String[] columns, int index) {
    ...
    public static double getValueDouble(String[] columns, int index) {
        if (index >= columns.length || columns[index].isEmpty()) {
            return 0;
        }
